...
class CloneInvoiceRepository {
    ...
    public function clone ($data = []) {
        ...
        //clone files
        if ($files = \App\Models\File::Where('fileresource_type', 'invoice')->Where('fileresource_id', $invoice->bill_invoiceid)->get()) {
